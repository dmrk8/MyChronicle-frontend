...
export const MediaNotes = ({
  ...
  return (
    <div className="relative group">
      <div className="bg-gradient-to-br from-zinc-800/60 to-zinc-900/60 rounded-xl border-2 border-zinc-700/50 shadow-xl backdrop-blur-sm overflow-hidden transition-all duration-300 hover:shadow-2xl hover:border-zinc-600/50">
        {/* Notepad Header */}
        <div className="bg-gradient-to-r from-zinc-800/80 to-zinc-800/60 px-5 py-4 border-b-2 border-zinc-700/50 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {showDelete && review && onDelete && (
                <button
                  ...
                  disabled={isDeleting}
                  className="flex items-center gap-2 px-4 py-2 bg-red-500 hover:bg-red-600 disabled:bg-zinc-700 text-white rounded-lg transition-all duration-200 text-sm font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5 disabled:cursor-not-allowed"
                >
                  <FaTrash size={13} />
