    ...
    <div className="bg-zinc-800/50 rounded-lg p-4 space-y-3">
      ...
      {manga && (
        <>
          ...
          {manga.volumes && <InfoItem label="Volumes" value={manga.volumes} />}
          {manga.startDate && (
            <InfoItem label="Start Date" value={manga.startDate} />
          )}
          {manga.endDate && <InfoItem label="End Date" value={manga.endDate} />}
      ...
      {movie && (
        <>
          ...
          {movie.originCountry && movie.originCountry.length > 0 && (
            <InfoItem label="Studios" value={movie.originCountry.join('\n')} />
          )}
      ...
      {tv && (
        <>
          ...
          {tv.networks && tv.networks.length > 0 && (
            <InfoItem label="Networks" value={tv.networks.join('\n')} />
          )}
          {tv.originalLanguage && (
            <InfoItem
              label="Language"
