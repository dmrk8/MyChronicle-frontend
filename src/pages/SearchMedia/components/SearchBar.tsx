          ...
          <div className="relative group">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-14 pr-10 py-5 bg-zinc-800/80 backdrop-blur-xl border border-zinc-700 rounded-2xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-lg"
              />
              {searchQuery && (
                <button
